...
const fichas: Record<string, FichaTecnica> = {
  ...
  "Vibra Conselheiro Carrão": {
    endereco: "Rua Diamante Preto, 944 — Vila Carrão, Zona Leste, São Paulo",
    statusObra: "Em obras — 5% concluído, comercialização a partir de março/2026",
    torres: 1,
    unidadesTotais: 421,
    tipologiasMetragens: "1 e 2 dorm. 27/37/42m², todas com varanda",
    precoAPartirDe: "R$ 249.700",
    faixasMCMV: "HIS2: 341 unidades (até R$ 383.636,74) | R2V: 80 unidades",
    vagasGaragem: "Sem vaga",
    transporte: "Bairro Vila Carrão",
    tourVirtualUrl: "https://app-vibra-residencial-prod-01.azurewebsites.net/tours/vibra-conselheiro-carrao/index.html",
    lazerCompleto: [
      "Bicicletário", "Praça", "Mini Quadra", "Playground", "Piscina Adulto", "Piscina Infantil",
      "Solário", "Pet Place", "Redário", "Espaço Delivery", "Espaço de Beleza", "Espaço Gourmet",
      "Pet Care", "Mini Mercado", "Salão de Festas", "Salão de Jogos", "Churrasqueira", "Academia",
      "Fitness Externo", "Brinquedoteca", "Espaço Luau",
    ],
  },
  "Vibra Parque Vila Prudente": {
    endereco: "Rua Salvador Mastropietro, 39 — Vila Ema/Vila Prudente, Zona Leste, São Paulo",
    statusObra: "Início de vendas junho/2026",
    torres: 1,
    unidadesTotais: 463,
    tipologiasMetragens: "1 e 2 dorm. 26/29/31/37/42/44/46m², com varanda",
    precoAPartirDe: "R$ 274.900",
    faixasMCMV: "HIS1: 25 unidades (R$ 223.700 a R$ 276.102,20) | HIS2: 335 unidades (R$ 226.800 a R$ 383.636,74) | R2V: 103 unidades",
    vagasGaragem: "Sem vaga",
    transporte: "5 min de carro até Estação Oratório (Linha 15-Prata)",
    tourVirtualUrl: "https://vibraresidencial.com.br/tours/parque_vila_prudente/index.html",
    lazerCompleto: [
      "Sport Bar", "Salão de Jogos", "Salão Gourmet", "Coworking", "Salão de Festas", "Espaço de Beleza",
      "Mini Mercado", "Brinquedoteca", "Pet Care", "Pet Place", "Playground", "Solário", "Piscina Adulto",
      "Bicicletário", "Churrasqueira", "Academia", "Espaço Delivery",
    ],
  },
  "Vibra Estação Vila Prudente": {
    endereco: "Rua Padre Faustino, 100 — Quinta da Paineira, Vila Prudente, Zona Leste, São Paulo",
    statusObra: "Em obras — 20% concluído, início de vendas outubro/2025",
    torres: 1,
    unidadesTotais: 480,
    tipologiasMetragens: "2 dorm. 34/37/41m²",
    precoAPartirDe: "R$ 254.900",
    faixasMCMV: "HIS2: 391 unidades (a partir de R$ 259.400, até R$ 383.636,74) | R2V: 89 unidades",
    vagasGaragem: "38 vagas comerciais, 1 PCD, 4 motos",
    transporte: "12 min a pé até Metrô Vila Prudente (Linhas 2-Verde e 15-Prata); 900m do Central Plaza Shopping",
    tourVirtualUrl: "https://vibraresidencial.com.br/tours/vila_prudente/index.html",
    lazerCompleto: [
      "Mini Mercado", "Academia", "Piscina", "Espaço Piquenique", "Salão de Jogos", "Pet Care",
      "Churrasqueira", "Bicicletário", "Salão de Festas", "Brinquedoteca", "Playground", "Pet Place",
      "Portaria", "Espaço Delivery", "Solário",
    ],
  },
  "Vibra Parque Cidade Universitária": {
    endereco: "Rua Murilo Mendes — Vila Butantã, Zona Oeste, São Paulo",
    statusObra: "Em obras — 60% concluído",
    torres: 3,
    unidadesTotais: 534,
    tipologiasMetragens: "1 dorm. 27m² | 2 dorm. 37 a 40m², várias plantas, com varanda",
    precoAPartirDe: "R$ 274.900",
    faixasMCMV: "HIS2: 417 unidades (até R$ 383.636,74) | R2V: 117 unidades, compatível com uso do FGTS",
    vagasGaragem: "Sem vaga",
    transporte: "5 min a pé do Metrô Butantã (Linha 4-Amarela); 2 min de carro do Portão 3 da USP Cidade Universitária",
    tourVirtualUrl: "https://app-vibra-residencial-prod-01.azurewebsites.net/tourvirtual/vibra-cidade-universitaria/index.html",
    lazerCompleto: [
      "Piscina adulto", "Piscina infantil", "Churrasqueira", "Academia", "Bicicletário", "Brinquedoteca",
      "Coworking", "Espaço Bar", "Espaço Beleza", "Pet Place", "Pet Care", "Playground", "Portaria",
      "Salão de Festas", "Salão de Jogos", "Espaço Delivery", "Minimercado",
    ],
  },
  "Vibra Parque Vila Sônia": {
    endereco: "Rua Caminho do Engenho, 600 — Vila Sônia, Zona Oeste, São Paulo",
    statusObra: "Início de comercialização maio/2026",
    torres: 3,
    unidadesTotais: 552,
    tipologiasMetragens: "1 dorm. 26/27m² | 2 dorm. 34/37/41m², com varanda",
    precoAPartirDe: "R$ 240.300",
    faixasMCMV: "HIS1: 316 unidades (a partir de R$ 235.000) | HIS2: 158 unidades (a partir de R$ 268.100) | R2V: 78 unidades",
    vagasGaragem: "Sem vaga",
    transporte: "6 min da Estação Vila Sônia (Linha 4-Amarela); 13 min de carro da futura Estação Parque Chácara do Jockey",
    lazerCompleto: [
      "Espaço Gourmet", "Coworking", "Espaço de Beleza", "Mini Mercado", "Pet Care", "Brinquedoteca",
      "Playground", "Churrasqueira", "Solário", "Piscina Adulto", "Piscina Infantil", "Academia",
      "Salão de Jogos", "Pet Place", "Salão de Festas", "Espaço Delivery",
    ],
  },
  "Vibra Estação Vila Sônia": {
    endereco: "Rua Dias Vieira, 432 — Vila Sônia, Zona Oeste, São Paulo",
    statusObra: "Em obras — 22% concluído",
    torres: 1,
    unidadesTotais: 623,
    tipologiasMetragens: "2 dorm. 37/41/43m²",
    precoAPartirDe: "R$ 284.900",
    faixasMCMV: "HIS2: 479 unidades (R$ 274.900 a R$ 383.636,74) | R2V: 144 unidades",
    vagasGaragem: "Sem vaga",
    transporte: "8 min de carro da Estação Vila Sônia-Profa. Elisabeth Tenreiro (Linha 4-Amarela)",
    tourVirtualUrl: "https://vibraresidencial.com.br/tourvirtual/vibra-vila-sonia/index.html",
    lazerCompleto: [
      "Espaço Delivery", "Mini Mercado", "Pet Care", "Academia", "Brinquedoteca", "Salão de Festas",
      "Espaço Gourmet", "Coworking", "Salão de Jogos", "Espaço de Beleza", "Sport Bar", "Piscina Adulto",
      "Espaço Luau", "Churrasqueira", "Mini Quadra", "Playground", "Fitness Externo", "Bicicletário",
      "Solário",
    ],
  },
  "Vibra Jardim Bonfiglioli": {
    endereco: "Rua Azem Abdalla, 571 — Jardim Bonfiglioli, Zona Oeste, São Paulo",
    statusObra: "Breve lançamento — previsão agosto/2026",
    torres: 2,
    unidadesTotais: 465,
    tipologiasMetragens: "2 dorm. 32/34/37/41/42m², varanda opcional",
    precoAPartirDe: "R$ 237.900 (HIS1) / R$ 272.900 (HIS2)",
    faixasMCMV: "HIS1: 122 unidades (até R$ 276.102,20) | HIS2: 282 unidades (até R$ 383.636,74) | R2V: 61 unidades",
    vagasGaragem: "Sem vaga",
    transporte: "10 min da Estação Vila Sônia-Profa. Elisabeth Tenreiro (Linha 4-Amarela)",
    lazerCompleto: [
      "Mini Mercado", "Espaço Gourmet", "Coworking", "Salão de Festas", "Brinquedoteca", "Churrasqueira",
      "Pet Care", "Bicicletário", "Sport Bar", "Salão de Jogos", "Academia", "Piscina Adulto", "Solário",
      "Playground", "Pet Place", "Espaço de Beleza", "Espaço Delivery",
    ],
  },
  "Vibra Vista Butantã": {
    endereco: "Rua Murilo Mendes, 3275 — Butantã, Zona Oeste, São Paulo",
    statusObra: "Em obras — 10% concluído",
    torres: 3,
    unidadesTotais: 475,
    tipologiasMetragens: "1 dorm. 26/27m² | 2 dorm. 34 a 42m², com varanda",
    precoAPartirDe: "R$ 235.900",
    faixasMCMV: "HIS1: 84 unidades (a partir de R$ 236.000, até R$ 276.102,20) | HIS2: 321 unidades (a partir de R$ 247.700, até R$ 383.636,74) | R2V: 70 unidades",
    vagasGaragem: "61 vagas padrão, 1 PCD, 4 motos",
    transporte: "7 min a pé da Estação Butantã (Linha 4-Amarela)",
    tourVirtualUrl: "https://app-vibra-residencial-prod-01.azurewebsites.net/tours/butanta-vista/index.html",
    lazerCompleto: [
      "Piscina Adulto", "Salão de Festas", "Salão de Jogos", "Salão Gourmet", "Brinquedoteca", "Playground",
      "Coworking", "Academia", "Espaço de Beleza", "Mini Mercado", "Pet Care", "Pet Place", "Solário",
      "Churrasqueira", "Espaço Delivery",
    ],
  },
};
